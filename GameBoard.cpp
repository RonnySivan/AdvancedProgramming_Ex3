...
GameBoard::GameBoard(OriginalBoard& originalBoard) : _originalBoard(originalBoard) { }   char GameBoard::charAt(Coordinate c) const { 	if (c.row > 0 && c.row < _originalBoard.rows() &&
